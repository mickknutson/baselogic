package com.baselogic.tutorials.ui.views;

import com.baselogic.bfl.ui.components.ChooseLanguage;
...
public class I18N extends Panel implements View
{
    ...
    public void PostConstruct() throws GeneralSecurityException {
        logger.info("*** I18N::PostConstruct()");
        setSizeFull();
    ...
    public void enter(ViewChangeListener.ViewChangeEvent viewChangeEvent){
        logger.info("*** I18N::enter(ViewChangeListener.ViewChangeEvent)");
    }
}
